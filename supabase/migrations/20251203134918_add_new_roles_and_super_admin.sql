...
-- 3. Makes Douglas (4e7caf61-cc73-407b-b18c-407d0d04f9d3) super_admin
-- 4. Updates RLS policies to allow super_admin/admin cross-account access
-- ============================================================================
...
-- Function: Check if user is admin (Legacy AI team)
...
-- ============================================================================
-- STEP 5: Make Douglas super_admin
-- ============================================================================

UPDATE users
SET role = 'super_admin'
WHERE id = '4e7caf61-cc73-407b-b18c-407d0d04f9d3'
  AND full_name = 'Douglas Talley';
...
BEGIN
  ...
  IF v_role = 'super_admin' THEN
    RAISE NOTICE '✅ Douglas is now super_admin';
  ELSE
    RAISE WARNING '⚠️  Douglas role is: % (expected super_admin)', v_role;
  END IF;
END $$;

-- ============================================================================
-- STEP 6: Update other critical RLS policies for cross-account access
-- ============================================================================
...
COMMENT ON FUNCTION is_admin() IS 'Returns true if user is admin (Legacy AI team)';
