...
import { extractContactInfo } from '@/lib/microsoft/contact-extractor'
import { decrypt } from '@/lib/microsoft/encryption'
import type { MicrosoftSyncResponse } from '@/lib/types/microsoft'

export const dynamic = 'force-dynamic'
export const revalidate = 0

export async function POST(request: Request): Promise<NextResponse<MicrosoftSyncResponse>> {
  try {
